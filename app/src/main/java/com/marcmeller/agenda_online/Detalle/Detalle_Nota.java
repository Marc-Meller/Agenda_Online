...
public class Detalle_Nota extends AppCompatActivity {
    ...
    private void Agregar_Nota_Importante(){
        if (user==null){
            //Si el usuario es nulo se mostrara el mensaje
            ...
            Nota_Importante.put("fechas_hora_actual",fecha_registro_R);
