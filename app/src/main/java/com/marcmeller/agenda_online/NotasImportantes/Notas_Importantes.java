...
import com.marcmeller.agenda_online.ViewHolder.ViewHolder_Nota_Importante;
...
public class Notas_Importantes extends AppCompatActivity {
    ...
    private void ComprobarUsuario(){
        if (user == null){
            Toast.makeText(com.marcmeller.agenda_online.NotasImportantes.Notas_Importantes.this, "Ha ocurrido un error", Toast.LENGTH_SHORT).show();
        }else {
