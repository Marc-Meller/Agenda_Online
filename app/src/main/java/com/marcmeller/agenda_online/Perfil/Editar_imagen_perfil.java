...
public class Editar_imagen_perfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Foto de perfil");
        ...
        databaseReference.child(user.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(Editar_imagen_perfil.this, "Imagen actualizada con exito", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
    ...
    private void ElegirImagede() {
        ...
        Btn_Elegir_Galeria.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(Editar_imagen_perfil.this, "Elegir de galeria", Toast.LENGTH_SHORT).show();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        //Setear la imagen
                        ImagenPerfilAtualizada.setImageURI(imagenUri);
    ...
    //Permiso para accedera la camara
